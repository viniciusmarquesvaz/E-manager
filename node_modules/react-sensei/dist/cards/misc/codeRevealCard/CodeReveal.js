...
const animation = index => keyframes`
    ...
    ${`${index * delay + 80}%`} { transform: translateY(${eitherSide * boxSize}px); }
...
const Wrapper = ({
  ...
  const codes = [code.substr(0, 1), code.substr(1, 1), code.substr(2, 1), code.substr(3, 1), code.substr(4, 1)];
  ...
  return /*#__PURE__*/React.createElement(Card, {
    cardTitle: "Code Reveal"
  }, /*#__PURE__*/React.createElement(CleanButton, {
    style: {
      marginBottom: "2rem"
    },
    isPrimary: true,
  ...
  }, "Reveal Code"), /*#__PURE__*/React.createElement(StyledWrapper, null, data.map((line, index) => /*#__PURE__*/React.createElement(StyledBoxBorder, null, /*#__PURE__*/React.createElement(StyledBox, null, /*#__PURE__*/React.createElement(StyledBoxNumbers, {
    index: index,
    isClicked: isClicked
  }, !isRevealed && /*#__PURE__*/React.createElement(React.Fragment, null, line.map(row => /*#__PURE__*/React.createElement(StyledBoxNumber, null, row)), /*#__PURE__*/React.createElement(StyledBoxNumber, null, codes[index]), line.map(row => /*#__PURE__*/React.createElement(StyledBoxNumber, null, row))), isRevealed && /*#__PURE__*/React.createElement(StyledBoxNumber, null, codes[index])))))));
};
