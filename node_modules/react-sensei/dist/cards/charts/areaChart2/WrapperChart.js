...
const StyledChartWrapper = styled(ChartWrapper)`
  width: 100%;
  height: ${p => p.chartWrapperHeightMobile};

  @media (min-width: ${p => p.theme.screenWidthMd}) {
    height: ${p => p.chartWrapperHeightDesktop};
  }

  & .ct-chart {
    width: 100%;
    height: ${p => p.chartHeightMobile};

    @media (min-width: ${p => p.theme.screenWidthMd}) {
      height: ${p => p.chartHeightDesktop};
    }
  }
...
const Wrapper = ({
  ...
  const createGradient = ctx => {
    var defs = ctx.svg.elem("defs"); // area gradient
  ...
  return /*#__PURE__*/React.createElement(StyledChartWrapper, {
    ...
    isAccent: isAccent,
    id: id
  }, options && data && /*#__PURE__*/React.createElement(Chartist, {
    listener: {
