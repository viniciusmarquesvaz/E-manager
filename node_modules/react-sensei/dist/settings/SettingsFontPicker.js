...
`;
const fonts = ["Poppins", "Sora", "Space Grotesk", "Varela Round", "Comfortaa" // "Montserrat",
// "Sora",
// "Red Hat Display",
// "Space Grotesk",
// "Work Sans",
...
const Wrapper = ({
  ...
  return /*#__PURE__*/React.createElement(StyledWrapper, null, fonts.map(font => /*#__PURE__*/React.createElement(StyledFontLabel, {
    key: uidv4(),
    htmlFor: font,
    ...
    isActive: isActive(font)
  }), /*#__PURE__*/React.createElement(StyledFontText, {
    isActive: isActive(font)
  }, font))));
};
